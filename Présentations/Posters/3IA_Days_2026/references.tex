\begingroup
\fontsize{23}{26}\selectfont\color{inriagrayblue}
\setlength{\columnsep}{1.4cm}\setlength{\parskip}{0.2cm}
\textbf{Selected references}\par\vspace{-0.3cm}
\begin{multicols}{2}\RaggedRight
\refb{1} J. A. Hartigan. \emph{Consistency of single linkage for high-density clusters}. Journal of the American Statistical Association, 76:388--394, 1981.\par
